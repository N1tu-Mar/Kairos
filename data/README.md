...
**Current state (2026-08-27): 59 candidate rows, 52 verified.**
...
decides and edits by hand. Latest run over all 59 rows: 39 unchanged, 11 with
passed deadlines, 4 dead, 3 with lost evidence, 2 redirected.
...
`scripts/form_coverage.py` prints which catalog rows have a form (2 of 59)
